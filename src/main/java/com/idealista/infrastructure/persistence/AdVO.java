...
public class AdVO { //debe estar separado la parte de los controladores con la parte de la base de datos y luego se debe utilizar un puente para comunicarlos
